...
<head>
  ...
  <title>Datenschutz – Florian</title>
...
<main>
  <div class="wrap">
    <div class="page-header">
      ...
      <h1 class="page-title" data-en="Privacy Policy" data-de="Datenschutzerklärung">Datenschutzerklärung</h1>
    </div>
    ...
    <div class="page-content">
      ...
      <div id="content-de">
        ...
        <h2>Cookies und Local Storage</h2>
        <p>
          Diese Website nutzt kein Tracking und keine Analyse-Cookies. Lediglich technisch notwendige
          Einstellungen (gewählte Sprache, gewähltes Farbschema) werden im Local Storage Ihres Browsers
          gespeichert. Diese Daten verlassen Ihr Gerät nicht und dienen ausschließlich der Verbesserung
